<%-- 
    Document   : main
    Created on : 30-08-2019, 21:06:58
    Author     : Neo Jigoku
--%>
            ...
            <div class="container">
                ...
                <nav id="menu-principal" class="collapse">
                    <ul>
                        ...
                        <li><a  href="registro_admin.jsp">Registrar Administrador</a></li>
                        <li><a href="registro_rana.jsp">Registrar Especie</a></li>
                        <li><a href="List_all_users.jsp">Lista de usuarios</a></li>
                        <li><a class="logout" href="logout.jsp">Cerrar sesión</a></li>
                        <li>Bienvenido Administrador: <%=hs.getAttribute("User")%></li>
                    </ul>
                </nav>
